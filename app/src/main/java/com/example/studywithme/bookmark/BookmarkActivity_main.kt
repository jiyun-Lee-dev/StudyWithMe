...
class BookmarkActivity_main: AppCompatActivity() {
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bookmark_category_createBtn.setOnClickListener {
            // 다이얼로그 빌더
            val bookmark_dialogBuilder = AlertDialog.Builder(this)
            // 레이아웃 인플레이터 선언
            ...
            val dialog_detailedWork_spinner = bookmark_dialogView.findViewById<Spinner>(bookmark_detailedWorkList)
            bookmark_dialogBuilder.setView(bookmark_dialogView)
                .setPositiveButton("확인") {dialogInterface, i ->
                    var dialog_categoryName_string = bookmark_dialogView.findViewById<EditText>(bookmark_categoryName).text.toString()
        ...
        val category_list_linearLayoutManager = LinearLayoutManager(this)
