...
class Home : Fragment() {
    ...
    fun changeTodayPieChart(doneRate: Float){
        ...
        pieData.add(SliceValue(doneRate, Color.BLUE))
        pieData.add(SliceValue(100 - doneRate, Color.GRAY))

        pieChartData = PieChartData(pieData)
        pieChartData!!.setHasCenterCircle(true).setCenterText1(doneRate.toString())
